...
import com.sistema.brewer.thymeleaf.BrewerDialect;

@Configuration
@EnableSpringDataWebSupport
@EnableCaching // configuração para colocar em cach
@EnableAsync //habilita a chamada assicronas
public class WebConfig extends WebMvcConfigurerAdapter {

	// resolver dos relatorios // dataSource = para conectar no banco de dados
	@Bean
	public ViewResolver jasperReportsViewResolver(DataSource datasource) {
		...
		resolver.setOrder(0); //ordem para verificar - verifica em primeiro
		return resolver;
	}
