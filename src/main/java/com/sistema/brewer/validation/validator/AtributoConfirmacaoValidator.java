package com.sistema.brewer.validation.validator;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object> {
	...
	public boolean isValid(Object object, ConstraintValidatorContext context) {
		...
		if (!valido) {
			...
			ConstraintViolationBuilder violationBuild = context.buildConstraintViolationWithTemplate(mensagem);
			violationBuild.addPropertyNode(atributoConfirmacao).addConstraintViolation();
		}
