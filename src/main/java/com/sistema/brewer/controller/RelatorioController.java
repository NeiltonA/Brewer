...
import com.sistema.brewer.dto.PeriodoRelatorio;
...
public class RelatorioController {
	...
	@PostMapping("vendasEmitidas")
	 public ModelAndView gerarRelatorioVendasEmitidos(PeriodoRelatorio periodoRelatorio, RedirectAttributes attributes) {
		...
		Date dataFim = Date.from(LocalDateTime.of(periodoRelatorio.getDataFim(), LocalTime.of(23, 59, 59))
				.atZone(ZoneId.systemDefault()).toInstant());
		if (StringUtils.isEmpty(periodoRelatorio.getDataInicio())) {
