...
Brewer.PesquisaRapidaCliente = (function() {
	...
	function PesquisaRapidaCliente() {
		...
		this.telefoneInput = $('#telefoneClienteModal');
...
Brewer.TabelaClientePesquisaRapida = (function() {
	...
	function onClienteSelecionado(evento) {
		...
		$('#telefoneCliente').val(clienteSelecionado.data('telefone'));
		$('#cpfOuCnpjCliente').val(clienteSelecionado.data('cpfOuCnpj'));
		console.log('cpfOuCnpj', clienteSelecionado.data('cpfOuCnpj'));
	}
