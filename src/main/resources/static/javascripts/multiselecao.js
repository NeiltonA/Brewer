...
Brewer.MultiSelecao = (function() {
	...
	function onSelecaoTodosClicado(){
		...
		this.selecaoCheckbox.prop('checked', status); //propriedade de todos ckeckbox igual ao status
		statusBotaoAcao.call(this, status);
	}
	
	function onSelecaoClicado(){
		var selecaoCheckboxChecados = this.selecaoCheckbox.filter(':checked');
		//se a selecao de checkbox for maior ou igual a quantidade de checkbox que existe define como 'checked'
	...
	// se é para ativar ou não o botao
